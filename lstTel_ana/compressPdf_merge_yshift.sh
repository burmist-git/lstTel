...
function mergePdf {
    ...
    #gs -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -sOutputFile=histSingle_lstTel_179theta_0phi_xxmx_xxmy.all.pdf histSingle_lstTel_179theta_0phi_7mx_0my.root.pdf histSingle_lstTel_179theta_0phi_5mx_5my.root.pdf histSingle_lstTel_179theta_0phi_0mx_7my.root.pdf histSingle_lstTel_179theta_0phi_m5mx_5my.root.pdf histSingle_lstTel_179theta_0phi_m7mx_0my.root.pdf histSingle_lstTel_179theta_0phi_m5mx_m5my.root.pdf histSingle_lstTel_179theta_0phi_0mx_m7my.root.pdf histSingle_lstTel_179theta_0phi_5mx_m5my.root.pdf\

    gs -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -sOutputFile=histSingle_lstTel_180theta_0phi_xxmx_xxmy.all.pdf histSingle_lstTel_180theta_0phi_7mx_0my.root.pdf histSingle_lstTel_180theta_0phi_5mx_5my.root.pdf histSingle_lstTel_180theta_0phi_0mx_7my.root.pdf histSingle_lstTel_180theta_0phi_m5mx_5my.root.pdf histSingle_lstTel_180theta_0phi_m7mx_0my.root.pdf histSingle_lstTel_180theta_0phi_m5mx_m5my.root.pdf histSingle_lstTel_180theta_0phi_0mx_m7my.root.pdf histSingle_lstTel_180theta_0phi_5mx_m5my.root.pdf
}
